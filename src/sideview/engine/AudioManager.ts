...
class AudioManager {
  ...
  // --- Cinematic Web Audio API Synthesis ---

  public playCinematicBassDrop() {
    this.initCtx();
    if (!this.ctx || !this.soundEnabled || !this.masterGain) return;
    ...
    // Bass drop frequency: 80Hz -> 20Hz over 2 seconds
    osc.frequency.setValueAtTime(80, t);
    osc.frequency.exponentialRampToValueAtTime(20, t + 2);
    
    // Volume envelope
    gain.gain.setValueAtTime(0, t);
    gain.gain.linearRampToValueAtTime(1.5, t + 0.1); // Sudden boom
    gain.gain.exponentialRampToValueAtTime(0.01, t + 2.5); // Slow fade
  ...
  public playAnimeExplosion() {
    ...
    noiseFilter.frequency.exponentialRampToValueAtTime(100, t + 2.5); // Filter sweeps down
    ...
    oscGain.gain.setValueAtTime(2.0, t); // Super loud initial crunch
