...
export class SideViewEngine {
  ...
  public castRemoteSkill(classId: string, skillIndex: number, startX: number, startY: number, facing: number, ownerSocketId?: string, skillDamage?: number) {
    ...
    if (classId === 'warrior') {
      if (skillIndex === 0) {
        this.particles.addSpellSlash(attackX, attackY - 20, facing, 1.4, '#ef4444');
        this.particles.addImpactBurst(attackX, attackY - 15, 10, '#ef4444', 'spark');
      } else if (skillIndex === 1) {
        this.particles.addFireSpin(startX, startY - 20, 1.8);
        this.particles.addImpactBurst(startX, startY - 15, 12, '#f97316', 'spark');
      } else if (skillIndex === 2) {
        this.particles.addSpellSlash(attackX, attackY, facing, 1.8, '#ef4444');
        this.particles.triggerScreenShake(8, 0.25);
        this.particles.addImpactBurst(attackX, attackY - 15, 15, '#ffd700', 'spark');
        ...
        this.particles.addImpactBurst(startX + facing * 200, startY - 15, 18, '#e53935', 'trail');
      } else if (skillIndex === 5) {
        this.particles.triggerScreenShake(22, 0.75);
        this.particles.addScreenFlash('#e53935', 0.6, 0.05);
    ...
    if (classId === 'assassin') {
      if (skillIndex === 0) {
        ...
        this.particles.addImpactBurst(attackX, attackY - 15, 10, '#a855f7', 'spark');
      } else if (skillIndex === 1) {
    ...
    if (classId === 'mage') {
      if (skillIndex === 0) {
        ...
        this.particles.addScreenFlash('#ef4444', 0.6, 0.05);
    ...
    if (classId === 'paladin') {
      if (skillIndex === 0) {
        ...
        this.particles.addImpactBurst(attackX, attackY, 12, '#facc15', 'spark');
      } else if (skillIndex === 1) {
        this.particles.addHolyPillar(startX, startY);
        this.particles.addMagicBarrier(startX, startY - 15, 1.5);
      } else if (skillIndex === 2) {
        ...
        this.particles.triggerScreenShake(24, 0.8);
        this.particles.addScreenFlash('#ffd700', 0.6, 0.05);
    ...
    if (classId === 'archer') {
      if (skillIndex === 0) {
        ...
        this.particles.addGroundTrap(startX + facing * 40, this.groundY, 0, 'poison');
      } else if (skillIndex === 3) {
        ...
        this.particles.triggerScreenShake(22, 0.75);
        this.particles.addScreenFlash('#22c55e', 0.6, 0.05);
    ...
    if (classId === 'priest') {
      if (skillIndex === 0) {
        ...
        this.particles.triggerScreenShake(24, 0.8);
        this.particles.addScreenFlash('#38bdf8', 0.6, 0.05);
    ...
    if (classId === 'ninja') {
      if (skillIndex === 0) {
        ...
        this.particles.triggerScreenShake(24, 0.85);
        this.particles.addScreenFlash('#a855f7', 0.6, 0.05);
