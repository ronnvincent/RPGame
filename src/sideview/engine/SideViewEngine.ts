    ...
    this.playSkillCastSfx(skill);
      ...
      if (classId === 'warrior') {
        if (skillIndex === 0) {
          ...
          this.particles.playSanjuVfx(startX + facing * 220, startY - 15, 'sanju_pure', 25, 24, 2.0, '#ef4444');
      ...
      if (classId === 'ninja') {
        if (skillIndex === 0) {
          this.particles.playSanjuVfx(attackX, attackY - 15, 'sanju_pure', 25, 24, 1.5, '#4ade80');
          ...
          this.particles.spawnShadowClones(startX, startY, facing, 0);
        } else if (skillIndex === 2) {
      ...
      if (classId === 'dragoon') {
        if (skillIndex === 0) {
          this.particles.playSanjuVfx(attackX, attackY - 15, 'sanju_fire', 25, 24, 1.6);
          ...
          this.particles.playSanjuVfx(attackX, this.groundY - 30, 'sanju_fire', 25, 24, 2.2);
          this.particles.addGroundExplosion(attackX, this.groundY - 20, 1.8);
          ...
          this.particles.playSanjuVfx(attackX, attackY - 15, 'sanju_pure', 25, 24, 2.0, '#f97316');
          this.particles.addProjectile(startX + facing * 20, startY - 10, facing * 14, 0, 'fireball', 0, false, true, '#ff5722', 18, true);
        } else if (skillIndex === 4) {
          this.particles.playSanjuVfx(startX, startY - 25, 'sanju_fire', 25, 24, 2.2);
          this.particles.addHolyPillar(startX, startY);
